          ...
          <CardHeader>
            <Row>
              <Col className="pr-md-1" md="4">
                <CardTitle tag="h4">Renounce Panel</CardTitle>
              </Col>
              <Col className="pr-md-1" md="8">
                <CardTitle tag="h4" style={{ marginLeft: '60px' }}>Renounce Event Log History</CardTitle>
              </Col>
            </Row>
          </CardHeader>
          <CardBody>
...
export default connect(mapStateToProps)(Renounce);
