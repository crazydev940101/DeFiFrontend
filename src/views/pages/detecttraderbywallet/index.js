...
import WalletList from "./component/WalletList.js";
import './index.css';

const DetectTraderByWallet = (props) => {
  ...
  return (
    <>
      ...
      <div className="content">
        <Row>
          <Col md="12">
            <WalletList credential={props.credential} showNotify={showNotify} />
          </Col>
        </Row>
...
export default connect(mapStateToProps)(DetectTraderByWallet);